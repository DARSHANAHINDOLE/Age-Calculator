...
if __name__ == '__main__':
    ...
    dob = Label(root, bg='powder blue')

    # Create the Given Date : Label
    givenDate = Label(root, text='Given Date', bg='orange')

    # Create the Given Date : Label
    birthDate = Label(root, text='Birth Date', bg='orange')

    # Create a Day : label
    day = Label(root, text='Day', bg='grey')

    # Create a Month : label
    month = Label(root, text='Month', bg='grey')

    # Create a Year : label
    year = Label(root, text='Year', bg='grey')

    # Create a Given Day : label
    givenDay = Label(root, text="current Day", bg="grey")

    # Create a Given Month : label
    givenMonth = Label(root, text="current Month", bg="grey")

    # Create a Given Year : label
    givenYear = Label(root, text="current Year", bg="grey")

    # Create a Years : label
    rsltYear = Label(root, text="Years", bg="grey")

    # Create a Month : label
    rsltMonth = Label(root, text="Month", bg="grey")

    # Create a Days : label
    rsltDay = Label(root, text="Days", bg="light pink")
    ...
    resultantAge = Button(root, text="Resultant Age", fg="Black", bg="powder blue", command=calculateAge)

    # Create a Clear All Button and attached to clearAll function
    clearAllEntry = Button(root, text="Clear All Output", fg='Black', bg='powder blue', command=clearAll)
